...
headers = {
    ...
    'Authorization': 'Bearer eyJhbGciOiJFUzUxMiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjI0OTkxIiwiZW1haWwiOiJ6dDEzMzcxNDIxODRAZ21haWwuY29tIiwicHVycG9zZSI6IndlYiIsImlhdCI6MTcxMDM5MTA4MiwiZXhwIjoxNzExNjAwNjgyfQ.AF0hUbNQqpXj7rmei4I3EL4FE-4VqpqaLZ50zBJxrIET2JcGG23COFnY9HiE37J5J8plgcAxLOKGTS9LkQ8aTOE2AMYc6JHpHHE0FWzYJPwzwywg5OBsrkVcbD5HjxYX9bHY95_V4tXicfFR-m6zna8P6EOkTNR_i47xJ4QtEfZjGftJ',  # 改左边
...
messageList = [
    rc("system",
       "You are 零号, a chat robot trained by 乐正格光,your master is 乐正,you can execute many instructions start with '/', such as '/echo hi'."),
]
...
def makedata(thisinput: str = "", thisuser: str = "user", lastuser: str = "user", lastinput: str = "",
    ...
    return {
        "session_id": "efb33e39-d8ce-47fc-9c40-50d71c984e47",  # 改左边
...
async def jx3api_request(url3, payload):
    async with httpx.AsyncClient() as client:
        response = await client.post(api_base_url + url3, params=payload)
...
#jx3api_active_today = on_command(head+"日常",priority=0)
jx3api_active_today = on_command("日常",priority=0, block=True)
...
async def _(bot: Bot, event: Event, i: str = ArgStr("i")):
    ...
    messageList = [
        rc("system",
           f"You are {i},your master is 乐正.You can execute many instructions start with '/',such as '/echo hi'."),
    ]
